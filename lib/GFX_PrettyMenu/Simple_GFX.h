    ...
    */
    ...
    void init(){
        // TFT setup
            ...
            _tft->reset();
            uint16_t identifier = _tft->readID();		// 33623 for HX8357D
...
public:
    ...
    void print_text_tl_coords(Simple_GFX<TFTClass> *sim_gfx, int16_t x_tl, int16_t y_tl, String text, uint16_t text_color, int8_t text_size, const GFXfont *font){
